...
//Representasi Dokter mengandung nama, id, preferensinya,total shiftnya, total pelanggaran preferensi
typedef struct
{
    int id;
    char nama[50];
...
//Representasi shift mengandung tipe shift,hari,id_dokter
typedef struct
{
    int hari;
    TipeShift tipe;
...
//Linked list datadokter , "single-linked-list"
struct datadokter
{
    char *nama;
    int shift_awal;
...
//Menambah node untuk linked list
...
//Membaca file csv dari output database||Perlu ganti gaperlu input nama_file
...
//Membersihkan memori ketika kode selesai atau keluar program
